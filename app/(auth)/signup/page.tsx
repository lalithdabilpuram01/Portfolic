...
export default function SignupPage() {
  return (
    <div className="min-h-screen bg-[#050a14] flex items-center justify-center px-6 relative overflow-hidden">
      ...
      />
      <div
        className="absolute bottom-0 right-1/3 w-80 h-80 rounded-full opacity-15 blur-3xl"
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        >
          ...
          <p className="text-slate-400 text-sm mb-6">Start building your portfolio in minutes.</p>
          <SignupForm />
        </div>
      </div>
    </div>
